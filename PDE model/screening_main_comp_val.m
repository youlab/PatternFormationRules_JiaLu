...
for i = 1:nt % time step
    ...
    [Ly_pre,T_pre,P_pre,RFP_pre,CFP_pre] = Advect_New(Ly_pre,T_pre,P_pre,RFP_pre,CFP_pre,Ce_pre,AOM,param,param.dt);
    ...
    % ------------------------------------------------------------
    % take cell density into consideration, calculate total RFP distribution
